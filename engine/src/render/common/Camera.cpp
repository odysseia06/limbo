...
void PerspectiveCamera::lookAt(const glm::vec3& target, const glm::vec3& up) {
    ...
    glm::vec3 const direction = glm::normalize(target - m_position);
...
glm::vec3 PerspectiveCamera::getForward() const {
    f32 const pitch = m_rotation.x;
    f32 const yaw = m_rotation.y;
...
void PerspectiveCamera::recalculateViewMatrix() {
    ...
    glm::mat4 const translation = glm::translate(glm::mat4(1.0f), m_position);
