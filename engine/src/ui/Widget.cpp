...
glm::vec4 Widget::getScreenBounds(const glm::vec2& screenSize) const {
    ...
    if (m_anchor == Anchor::TopLeft || m_anchor == Anchor::TopCenter ||
        m_anchor == Anchor::TopRight) {
        offset.y = -offset.y - m_size.y;  // Subtract size to position from top edge
    }
    if (m_anchor == Anchor::BottomRight || m_anchor == Anchor::CenterRight ||
        m_anchor == Anchor::TopRight) {
...
glm::vec2 Widget::getAnchorPosition(const glm::vec2& parentSize) const {
    switch (m_anchor) {
    case Anchor::TopLeft:
        return glm::vec2(0.0f, parentSize.y);
    case Anchor::TopCenter:
        return glm::vec2(parentSize.x * 0.5f, parentSize.y);
    case Anchor::TopRight:
        return glm::vec2(parentSize.x, parentSize.y);
    case Anchor::CenterLeft:
        return glm::vec2(0.0f, parentSize.y * 0.5f);
    case Anchor::Center:
        return glm::vec2(parentSize.x * 0.5f, parentSize.y * 0.5f);
    case Anchor::CenterRight:
        return glm::vec2(parentSize.x, parentSize.y * 0.5f);
    case Anchor::BottomLeft:
        return glm::vec2(0.0f, 0.0f);
    case Anchor::BottomCenter:
        return glm::vec2(parentSize.x * 0.5f, 0.0f);
    case Anchor::BottomRight:
        return glm::vec2(parentSize.x, 0.0f);
    }
